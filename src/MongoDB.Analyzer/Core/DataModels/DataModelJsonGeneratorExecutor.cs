...
internal sealed class DataModelJsonGeneratorExecutor
{
    private readonly Type _testClassType;

    public string DriverVersion { get; }

    public DataModelJsonGeneratorExecutor(Type testClassType)
    {
    ...
    private string GetDriverVersion()
    {
        try
        {
            return (string)_testClassType.GetMethod(JsonGeneratorSyntaxElements.GetDriverVersion).Invoke(null, new object[] { });
        }
        catch { }
